 ...
 * Technogate
 *
 * This class loads modules configs from application/modules/modulename/configs/module.ini
 *
 * @package Technogate_Controller_Plugin_ModuleLoader
 * @author Wael Nasreddine (TechnoGate) <wael@technogate.fr>
 */
class Technogate_Application_Resource_Modulesetup extends Zend_Application_Resource_ResourceAbstract {
